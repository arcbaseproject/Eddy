...
internal val settingsIndex = listOf(
    ...
    SettingEntry("Homepage layout", listOf(APPEARANCE), "home density compact comfortable"),
    SettingEntry("Shortcut appearance", listOf(APPEARANCE), "icons shapes circles squircles"),
