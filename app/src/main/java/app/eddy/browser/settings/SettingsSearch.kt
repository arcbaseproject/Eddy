...
internal val settingsIndex = listOf(
    ...
    SettingEntry("Show title", listOf(APPEARANCE, START_PAGE), "wordmark name heading start page"),
    SettingEntry("Title text", listOf(APPEARANCE, START_PAGE), "wordmark rename greeting start page"),
